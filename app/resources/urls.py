...
urlpatterns = [
    ...
    path("api/resources/ai-search/", views.api_ai_search_resources, name="api_ai_search"),
    path("api/resources/search-only/", views.api_ai_search_resources, name="api_search_only"),
